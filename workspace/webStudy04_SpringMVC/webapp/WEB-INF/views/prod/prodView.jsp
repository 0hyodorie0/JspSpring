...
<table class="table table-bordered">
   ...
   <tr>
      ...
      <input type="button" value="수정" class="linkBtn btn btn-primary" data-href="${updateURL}">
      <input type="button" value="삭제" class="linkBtn btn btn-primary"/>
      <input type="button" value="목록" class="linkBtn btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/prod/prodList.do'">
      </td>
   </tr>
</thead>
</table>
