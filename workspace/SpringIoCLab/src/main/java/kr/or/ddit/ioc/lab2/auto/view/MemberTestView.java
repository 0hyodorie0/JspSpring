...
public class MemberTestView {
	public static void main(String[] args) {
		ConfigurableApplicationContext parentContext = new GenericXmlApplicationContext("classpath:/kr/or/ddit/ioc/lab2/conf/Auto-DI.xml");
...
//		context.registerShutdownHook();
		...
		String memId = "a001";
		MemberRetrieveController controller = childContext.getBean(MemberRetrieveController.class);
