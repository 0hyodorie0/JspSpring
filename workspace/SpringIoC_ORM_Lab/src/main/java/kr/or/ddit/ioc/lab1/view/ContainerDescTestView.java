...
public class ContainerDescTestView {
	public static void main(String[] args) {
		ConfigurableApplicationContext context =
				new GenericXmlApplicationContext("classpath:/kr/or/ddit/ioc/lab1/conf/Container-Desc.xml");
		context.registerShutdownHook();
//		SampleService service1 = 
//				context.getBean("sampleService_CI", SampleService.class);
//		SampleService service2 = 
//				context.getBean("sampleService_CI", SampleService.class);
//		SampleService service3 = 
//				context.getBean("sampleService_SI", SampleService.class);
//		
//		System.out.println(service1 == service3);
//		
//		SampleDAOImpl_MariaDB mariaDAO1 =
//				context.getBean(SampleDAOImpl_MariaDB.class);
//		SampleDAOImpl_MariaDB mariaDAO2 =
//				context.getBean(SampleDAOImpl_MariaDB.class);
//		
